...
namespace Laba3
{
    ...
    class Program
    {
        private const string FileName = "D:/University/RIS/Laba2/Laba2/products.txt";
        ...
        {
            Console.WriteLine("Список овощей на складе:");
            foreach (var product in products)
            {
        ...
        {
            Console.Write("Введите наименование овоща: ");
            string name = Console.ReadLine();

            decimal price;
            while (true)
            {
                Console.Write("Введите цену овоща: ");
            ...
            while (true)
            {
                Console.Write("Введите количество овощей: ");
        ...
        private static void UpdateProduct(List<Product> products)
        {
            ...
            if (productToUpdate != null)
            {
                ...
                Console.Write("Введите новое наименование овоща: ");
                newName = Console.ReadLine();

                while (true)
                {
                    Console.Write("Введите новую цену овоща: ");
                ...
                while (true)
                {
                    Console.Write("Введите новое количество овоща: ");
        ...
        {
            Console.Write("Введите наименование овоща для поиска: ");
